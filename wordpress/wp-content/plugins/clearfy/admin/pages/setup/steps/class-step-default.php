 ...
 * @version 1.0
 */
class Step_Default extends \WBCR\Factory_Templates_113\Pages\Step_Custom {
	...
	public function html()
	{
		...
		<div class="w-factory-templates-113-setup__inner-wrap">
			<div class="w-factory-templates-113-setup-step__new_onboarding-wrapper">
				<p class="w-factory-templates-113-setup-step__new_onboarding-welcome">Welcome to</p>
				<h1 class="w-factory-templates-113-logo">
